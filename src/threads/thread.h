...
struct thread
  {
    ...
    int original_priority;              /* When priority donated  this saving original priority */
    int niceness;                       /* Niceness. */
    int recent_cpu;                     /* CPU time that process has received "recently".*/
    int64_t wake_ticks;                 /* Wake up system ticks */
